            ...
            <CardContent>
              <form className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="craft-name" placeholder="e.g., Handwoven Silk Dupatta" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="craft-category">Category</Label>
                  <Input id="craft-category" placeholder="Textiles, Pottery, Jewelry, Woodwork" />
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="craft-price">Price (INR)</Label>
                    <Input id="craft-price" type="number" min="0" placeholder="2499" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="craft-stock">Available Stock</Label>
                    <Input id="craft-stock" type="number" min="0" placeholder="10" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="craft-images" type="file" multiple />
